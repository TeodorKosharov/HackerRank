...
if minutes == '00':
    print(f"{possible_hours[hour]} o' clock")
elif int(minutes) <= 30:

    print(f"{possible_minutes[minutes]} past {possible_hours[hour]}")
else:
    remaining_minutes = str(60 - int(minutes))
    print(f"{possible_minutes[remaining_minutes]} to {possible_hours[hour + 1]}")
